...
frappe.ui.form.on('Team', {
	// Upon change of the team_name create a short name of maximun 3 characters and being capital case, and set it to the field short_name
	// I want the short name to be the first letter of each word in the team_name
	...
	team_name: function(frm) {
		var team_name = frm.doc.team_name;
		var short_name = "";
		var words = team_name.split(" ");
		if (words.length > 0) {
			if (words.length == 1) {
