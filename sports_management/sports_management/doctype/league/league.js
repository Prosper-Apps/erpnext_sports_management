...
frappe.ui.form.on('League', {
	// Upon change of the league_name create a short name of maximun 3 characters and being capital case, and set it to the field short_name
	// I want the short name to be the first letter of each word in the league_name
	...
	league_name: function(frm) {
		var league_name = frm.doc.league_name;
		var short_name = "";
		var words = league_name.split(" ");
		if (words.length > 0) {
			if (words.length == 1) {
